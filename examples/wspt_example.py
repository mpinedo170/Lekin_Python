...
jobs = [
    ...
    Job("J3", release=3, due=26, weight=5, rgb=(0, 0, 255), operations=[Operation("MainWC", 6, "A")]),
    ...
    Job("J7", release=10, due=35, weight=3, rgb=(0, 255, 255), operations=[Operation("MainWC", 5, "A")])
]
